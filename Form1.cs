...
namespace Aidana
{
   ...
   int[] lpaRgbValues);
        ...
        unsafe private void button1_Click(object sender, EventArgs e)
        {
            ...
            label10.Text = "Скрость мыши: " + speed;
            ...
            label11.Text = "Цвет Фона окна : " + "[R=" + color.R + " G= " + color.G + " B= " + color.B + "]";
            ...
            label12.Text = "Цвет фона для элементов управления" + "[R=" + color3.R + " G= " + color3.G + " B= " + color3.B + "]";
            ...
            label13.Text = "Цвет Рабочего стола: " + "[R=" + color5.R + " G= " + color5.G + " B= " + color5.B + "]";
